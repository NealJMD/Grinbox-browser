...
//                  that.readThread(threadid);
               ...
               if (matches != null && matches.length > 0) {
                  ...
                  logToConsole("no matches!");
               }
            } else {
               logToConsole("status or readystate problem. readyState="+this.readyState+", status="+this.readyState);
            }
         }
         ...
         gt_xhr.send(null);
      } else { logToConsole("null threadid!"); }
   }
